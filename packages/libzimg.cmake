...
ExternalProject_Add(libzimg
    ...
    UPDATE_COMMAND ""
    CONFIGURE_COMMAND ${EXEC} rm -rf <SOURCE_DIR>/graphengine && ln -sf ${src_graphengine} <SOURCE_DIR>/graphengine && NOCONFIGURE=1 <SOURCE_DIR>/autogen.sh && CONF=1 <SOURCE_DIR>/configure
        --host=${TARGET_ARCH}
